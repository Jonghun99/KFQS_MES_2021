    ...
    public partial class AP_ProductPlan : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                string sOrderNumber    = Convert.ToString(txtOrderNo.Text);
                string sOrderCloseFlag = Convert.ToString(cboOrderCloseFlag.Value);

                DataTable rtnDtTemp = new DataTable();
                rtnDtTemp = helper.FillTable("18AP_ProductPlan_S1", CommandType.StoredProcedure
                                    , helper.CreateParameter("PLANTCODE",      sPlantCode,      DbType.String, ParameterDirection.Input)
                                    , helper.CreateParameter("WORKCENTERCODE", sWorkcenterCode, DbType.String, ParameterDirection.Input)
                                    , helper.CreateParameter("ORDERNO",        sOrderNumber,    DbType.String, ParameterDirection.Input)
                ...
                foreach (DataRow drRow in dtTemp.Rows)
                {
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            #region 삭제
                            drRow.RejectChanges();
                            helper.ExecuteNoneQuery("18AP_ProductPlan_D1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("18AP_ProductPlan_I1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("18AP_ProductPlan_U1", CommandType.StoredProcedure
                                                  , helper.CreateParameter("PLANTCODE", drRow["PLANTCODE"].ToString(), DbType.String, ParameterDirection.Input)
